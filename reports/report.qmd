...
GITHUB URL:  <https://github.com/cmsc-vcu/cmsc408-sp2025-hw8-RayanBTW/blob/319b4aab52b244f617e718302601623738165635/reports/report.qmd>
...
Throughout this assignment, I used a variety of SQL skills including basic SELECT queries, filtering with WHERE, aggregating with GROUP BY, joining tables, and using Common Table Expressions (CTEs). I feel most confident in writing simple queries that involve selecting, filtering, and basic aggregations. I also feel more comfortable with ORDER BY and using functions like COUNT().
However, I need more practice with writing more complex queries involving CTEs, especially when nesting multiple CTEs together, like in Tasks 18, 19, and 20. This assignment helped reinforce how important it is to carefully plan queries step-by-step, especially when dealing with aggregation and joins. It also showed me how SQL can be used not just to retrieve data, but to transform and summarize it for analysis.

2. Problem-Solving Approach: Describe your approach to tackling the more complex tasks (like Tasks 18, 23, and 24). How did you break down these problems, and what steps did you take when you encountered challenges? How would you approach a similar problem differently in the future?

For the more complex tasks, I broke down each problem into smaller steps. First, I carefully re-read the problem statement to understand exactly what was being asked. Then, I thought about how I could build the query one piece at a time: starting with a basic SELECT, then adding GROUP BY, and finally building CTEs if necessary.
Whenever I got stuck, I simplified the query and tested it at each step before adding more layers. If I had to approach a similar problem again, I would sketch out the tables and expected output on paper first before writing SQL. This would help avoid confusion when combining multiple steps together. I also learned that running small pieces of the query before combining them into a big query made it much easier to find and fix mistakes.


3. Learning Takeaways: Consider the overall learning experience from this assignment. What were the biggest takeaways about working with SQL for data analysis and transformation? How do you think these skills will apply in real-world scenarios or future coursework?

One of the biggest takeaways from this assignment is understanding how powerful SQL is for data analysis and transformation. SQL is not just about pulling raw data — it’s about grouping, summarizing, and reshaping data to answer real-world questions. I also learned that when working with real datasets, there are often missing values or non-standard entries, and it’s important to know how to handle them correctly.
These skills will definitely apply in future coursework where I need to work with larger datasets. In real-world jobs, especially those involving data analysis, business intelligence, or database management, being able to write clean and efficient SQL queries will be critical. This assignment gave me a strong foundation to build on for more advanced SQL work.
